...
var AvatarContainer = styled(avatar.Root, avatarContainer);
var AvatarImage = styled(avatar.Image, avatarImage);
var AvatarFallback = styled(avatar.Fallback, avatarFallback);
var Avatar = (props) => {
...
var Box = styled("div", box);
Box.displayName = "Box";

// src/Button/Button.tsx
import { button } from "@stackup-ui/styles";
var Button = styled("button", button);
...
var CircularProgressContainer = styled("span", circularProgressContainer);
var CircularProgressCircle = styled("circle", circularProgressCircle);
var CircularProgress = (props) => {
  return /* @__PURE__ */ jsx2(CircularProgressContainer, __spreadProps(__spreadValues({}, props), { children: /* @__PURE__ */ jsx2("svg", { viewBox: "22 22 44 44", children: /* @__PURE__ */ jsx2(
    CircularProgressCircle,
    {
      cx: "44",
      cy: "44",
...
var Steps = styled("div", steps);
var Step = styled("div", step);
function MultiStep({ size, currentStep = 1 }) {
  return /* @__PURE__ */ jsx3(MultiStepContainer, { children: /* @__PURE__ */ jsx3(Steps, { css: { "--steps-size": size }, children: Array.from({ length: size }, (_, i2) => i2 + 1).map((step2) => {
    return /* @__PURE__ */ jsx3(Step, { active: currentStep >= step2 }, step2);
  }) }) });
}
...
var TextArea = styled("textarea", textArea);
...
var TextFieldRoot = styled("div", textFieldRoot);
TextFieldRoot.displayName = "TextField.Root";
var TextFieldIcon = styled("span", textFieldIcon);
TextFieldIcon.displayName = "TextField.Icon";
var TextFieldPrefix = styled("div", textFieldPrefix);
TextFieldPrefix.displayName = "TextField.Prefix";
var TextFieldInput = styled("input", textFieldInput);
